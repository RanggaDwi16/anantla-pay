...
mixin _$BalanceModel {
  ...
  num? get balance => throw _privateConstructorUsedError; //add bool islimited
//country code
...
class _$BalanceModelImpl implements _BalanceModel {
  const _$BalanceModelImpl(
      ...
      @JsonKey(name: "is_limited") this.isLimited,
...
//country code
  ...
  @override
  String toString() {
    return 'BalanceModel(walletId: $walletId, walletCode: $walletCode, currency: $currency, walletStatus: $walletStatus, createdAt: $createdAt, balance: $balance, countryCode: $countryCode, isLimited: $isLimited, totalReceived: $totalReceived, totalSpent: $totalSpent)';
  }
...
abstract class _BalanceModel implements BalanceModel {
  ...
  @override
  @JsonKey(name: "balance")
  num? get balance; //add bool islimited
//country code
  @override
  @JsonKey(name: "country_code")
