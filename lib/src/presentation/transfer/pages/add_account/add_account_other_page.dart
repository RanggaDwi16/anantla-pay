...
class AddAccountOtherPage extends StatefulHookConsumerWidget {
  const AddAccountOtherPage({super.key});

  @override
  ConsumerState<AddAccountOtherPage> createState() =>
      _AddAccountOtherPageState();
}

class _AddAccountOtherPageState extends ConsumerState<AddAccountOtherPage> {
  String? selectedBank;
