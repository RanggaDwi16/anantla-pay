...
import 'package:anantla_pay/src/presentation/transfer/widgets/bank_reason/bank_reason_bottom_sheet.dart';
import 'package:flutter/material.dart';
import 'package:gap/gap.dart';
import 'package:go_router/go_router.dart';

class TransferBankReasonPage extends StatefulWidget {
  const TransferBankReasonPage({super.key});

  @override
  State<TransferBankReasonPage> createState() => _TransferBankReasonPageState();
}

class _TransferBankReasonPageState extends State<TransferBankReasonPage> {
            ...
            GestureDetector(
              onTap: () async {
                final result = await showModalBottomSheet<String>(
                  ...
                  builder: (context) => const BankReasonBottomSheet(),
                );
