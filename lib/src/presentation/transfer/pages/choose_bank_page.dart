...
class ChooseBankPage extends ConsumerStatefulWidget {
  const ChooseBankPage({super.key});

  @override
  ConsumerState<ChooseBankPage> createState() => _ChooseBankPageState();
}
                  ...
                  data: (data) {
                    return BankCard(
                      onTap: () {
                        ...
                        context.pushNamed(RouteName.transferBankAmount);
                      },
